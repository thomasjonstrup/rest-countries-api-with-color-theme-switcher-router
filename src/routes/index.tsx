		...
		<div className='p-2'>
			...
			<div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-2">
				{filteredData.map((country) => (
					<Link to={`/detail/$countryId`} params={{ countryId: country.cca2 }} key={country.name.common}  className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
